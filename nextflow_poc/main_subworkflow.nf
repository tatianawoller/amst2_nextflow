...
workflow {
    ...
    AMST2_AMST(params.default_elastix,params.transform_default,params.transform_amst, params.elx,AMST2_PREALIGN.out.prealigned,params.out_amst,params.folder_amst)
